...
function onFormSubmit(e) {
    e.preventDefault();
    if (!e.target.elements.email.value || !e.target.elements.message.value) return window.alert("Please, fill in all the necessary fields");
...
function populateTextarea() {
    if (savedMessage) for (let key of keys)form.elements.key.value = formData.key;
}
